...
public class AutoCompletition extends PlainDocument {
	...
	public AutoCompletition(final JComboBox<String> comboBox, String[] values) {
		this.comboBox = comboBox;
		AutoCompletition.values = values;
	...
	public static void enable(JComboBox<String> comboBox, String[] values) {
		// has to be editable
		comboBox.setEditable(true);
		// change the editor's document
		new AutoCompletition(comboBox, values);
	}
